package embCoding.com.presentation;


import embCoding.com.metier.IMetier;
...
@ComponentScan(basePackages = {"embCoding.com.dao", "embCoding.com.metier"})  // Indique à Spring de scanner ces packages pour trouver des beans
